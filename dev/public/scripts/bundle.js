...
(function () {
  ...
  var infoWindow = function infoWindow(Attr2Options, $compile, $timeout, $parse) {
    var parser = Attr2Options;
...
(function () {
  ...
  var mapDirective = function mapDirective(Attr2Options, $timeout, $parse) {
    var parser = Attr2Options;
     ...
     */
    var linkFunc = function linkFunc(scope, element, attrs, ctrl) {
      var orgAttrs = parser.orgAttributes(element);
       ...
       * initialize function
       */
      var initializeMap = function initializeMap(mapOptions, mapEvents) {
...
(function () {
   ...
   */
  var MapController = function MapController($q, NavigatorGeolocation, GeoCoder, Attr2Options) {
    var parser = Attr2Options;
    var _this = this;

    var observeAndSet = function observeAndSet(attrs, attrName, object) {
      attrs.$observe(attrName, function (val) {
        if (val) {
...
(function () {
  ...
  var marker = function marker(Attr2Options, $parse) {
    var parser = Attr2Options;
    var linkFunc = function linkFunc(scope, element, attrs, mapController) {
      var orgAttrs = parser.orgAttributes(element);
      var filtered = parser.filter(attrs);
...
(function () {
  ...
  var placesAutoComplete = function placesAutoComplete(Attr2Options, $timeout) {
    var parser = Attr2Options;
...
(function () {
  ...
  var shape = function shape(Attr2Options, $parse) {
    var parser = Attr2Options;
...
(function () {
  ...
  var streetViewPanorama = function streetViewPanorama(Attr2Options) {
    var parser = Attr2Options;
    ...
    var linkFunc = function linkFunc(scope, element, attrs, mapController) {
      ...
      console.log('street-view-panorama', 'options', svpOptions, 'events', svpEvents);
...
(function () {
  ...
  var Attr2Options = function Attr2Options($parse, $timeout, NavigatorGeolocation, GeoCoder) {
    ...
    var getAttrsToObserve = function getAttrsToObserve(attrs) {
      ...
      if (attrs['ng-repeat'] || attrs.ngRepeat) {
        // if element is created by ng-repeat, don't observe any
        void 0;
      } else {
     ...
     */
    var getOptions = function getOptions(attrs, scope) {
      var options = {};
      for (var key in attrs) {
        if (attrs[key]) {
          if (key.match(/^on[A-Z]/)) {
...
(function () {
  'use strict';
  var GeoCoder = function GeoCoder($q) {
    return {
      /**
       * @memberof GeoCoder
...
(function () {
  ...
  var NavigatorGeolocation = function NavigatorGeolocation($q) {
    return {
      /**
...
(function () {
  ...
  var StreetView = function StreetView($q) {
